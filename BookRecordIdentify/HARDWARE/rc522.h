...
extern unsigned char Flag_find_card;
...
#define          RC522_CS_Enable()         GPIO_ResetBits ( GPIOC, GPIO_Pin_0 )
#define          RC522_CS_Disable()        GPIO_SetBits ( GPIOC, GPIO_Pin_0)



#define          RC522_SCK_0()             GPIO_ResetBits( GPIOC, GPIO_Pin_1 )
#define          RC522_SCK_1()             GPIO_SetBits ( GPIOC, GPIO_Pin_1 )

#define          RC522_MOSI_0()            GPIO_ResetBits( GPIOC, GPIO_Pin_3 )
#define          RC522_MOSI_1()            GPIO_SetBits ( GPIOC, GPIO_Pin_3 )

#define          RC522_MISO_GET()          GPIO_ReadInputDataBit ( GPIOC, GPIO_Pin_2 )

void             RC522_Handel               (void);
void             RC522_Handel1               (void);
void 						 RC522_Read										(u8 addr);
void             RC522_Write								(u8 addr,u8 DATA[16]);
